   ...
   <div class="flex justify-center items-center pt-8">
      <div
         ...
         <form
            ...
            <div class="space-y-4">
               <div>
                  <label htmlFor="email" class="block mb-2 text-sm"> Name </label>
                  <input
                     v-model="name"
                     type="text"
                     name="name"
               ...
               <div>
                  <label htmlFor="image" class="block mb-2 text-sm">
                     Select Image:
                  </label>
         ...
         <div class="flex items-center pt-4 space-x-1">
            ...
            <p class="px-3 text-sm dark:text-gray-400">Signup with social accounts</p>
            <div class="flex-1 h-px sm:w-16 dark:bg-gray-700"></div>
         </div>
            ...
            .then((result) => {
               ...
               updateUserProfile(name.value, imageData?.data.display_url)
                  .then(() => {
                     ...
                     swalToast("User created successfully", "success", true, false);
                     loading.value = false;
