<template>
    <div class='flex justify-center items-center pt-8'>
        <div class='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900'>
            ...
            <form @submit.prevent="handleSubmit" noValidate='' action=''
                ...
                <div class='space-y-4'>
                    <div>
                        ...
                        <input v-model="name" type='text' name='name' id='name' placeholder='Enter Your Name Here'
            ...
            <div class='flex justify-center space-x-4'>
                <button @click="handleGoogleSignin" aria-label='Log in with Google' class='p-3 rounded-sm'>
