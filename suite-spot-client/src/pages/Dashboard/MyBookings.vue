...
<template>
   <div >
        ...
        <div  v-if="!loading && bookings && Array.isArray(bookings) && bookings.length > 0"
                    ...
                    <div class='inline-block min-w-full shadow rounded-lg overflow-hidden'>
                        <table class='min-w-full leading-normal'>
                            ...
                            <tbody>
                                ...
                                <TableRow key={booking._id} booking={booking} fetchBookings={fetchBookings} />
                                ))} -->
                                <TableRow v-for="booking in bookings" :key="booking._id" :booking="booking"
                                 ></TableRow>
                            </tbody>
                        </table>
                    </div>
